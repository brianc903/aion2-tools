...
3. Use **Hide/Show PVE Scores**, the ↑/↓ controls to reorder teams, the per-subteam **3 DPS + 1 治癒星 ↔ 4 DPS** toggle to change compositions, **Add Team**, or **Reset Teams** as needed. Each team always has two subteams (A/B) with 4 slots each.
